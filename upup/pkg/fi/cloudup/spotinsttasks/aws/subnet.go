...
func (_ *Subnet) RenderAWS(t *spotinst.SpotinstAPITarget, a, e, changes *Subnet) error {
	...
	if a == nil {
		...
		response, err := t.Cloud.CloudProvider().(awsup.AWSCloud).EC2().CreateSubnet(request)
		if err != nil {
