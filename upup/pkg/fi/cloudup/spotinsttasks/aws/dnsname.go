...
func (_ *DNSName) RenderAWS(t *spotinst.SpotinstAPITarget, a, e, changes *DNSName) error {
	...
	response, err := t.Cloud.CloudProvider().(awsup.AWSCloud).Route53().ChangeResourceRecordSets(request)
	if err != nil {
