...
import (
	...
	resources_aws "k8s.io/kops/pkg/resources/aws"
...
// ListResourcesAWS returns a list of all AWS resources as Resource objects.
func ListResourcesAWS(cloud fi.Cloud, clusterName string) ([]*resources.Resource, error) {
	var resourceTrackers []*resources.Resource

	resources, err := resources_aws.ListResourcesAWS(cloud.(awsup.AWSCloud), clusterName)
	if err != nil {
		return nil, err
	}
...
// ListResourcesSpotinst returns a list of all Spotinst resources as Resource objects.
func ListResourcesSpotinst(cloud fi.Cloud, clusterName string) ([]*resources.Resource, error) {
	return ListGroups(cloud.(Cloud).Spotinst(), clusterName)
}
